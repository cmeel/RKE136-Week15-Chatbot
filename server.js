...
app.get('/', (req, res) => {
    let url = 'https://api.themoviedb.org/3/movie/361743?api_key=b1850778d76ce3414a5549db2c2de30e';
    axios.get(url)
    .then(response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=b1850778d76ce3414a5549db2c2de30e&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=b1850778d76ce3414a5549db2c2de30e&language=en-US';
